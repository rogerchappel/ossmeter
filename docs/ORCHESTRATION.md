# ORCHESTRATION: ossmeter

Owner: one isolated project sub-agent.
Workspace: /Users/roger/Developer/my-opensource/ossmeter only.
...
## Publish
- Create public GitHub repo: https://github.com/rogerchappel/ossmeter
- Push main directly when verified.
- Configure repo description and topics.
- Run /Users/roger/.openclaw/workspace/scripts/protect-github-main.sh rogerchappel ossmeter main if available.
