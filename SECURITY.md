...
Replace this section with the supported versions for `ossmeter`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ossmeter` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ossmeter.
