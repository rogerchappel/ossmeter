# Agent Operating Instructions for ossmeter

This file defines how AI agents and human maintainers should work in `ossmeter`.

## Project Context

- Project: `ossmeter`
- Repository: `https://github.com/rogerchappel/ossmeter` (`rogerchappel/ossmeter`)
- Primary maintainer: `Roger Chappel`
- Default branch: `main`
- Package manager: `npm` (`package-lock.json`; use `npm ci` for reproducible installs)
